...
var baseMultiplier = 1.1; // Target multiplier: 1.13 recommended
var variableBase = false; // Enable variable mode (very experimental), read streakSecurity.
var streakSecurity = 50; // Number of loss-streak you wanna be safe for. Increasing this massively reduces the variableBase calculated. (1-loss = 20%, 2-loss = 5%, 3-loss = 1.25% of your maximum balance). Recommended: 2+
var maximumBet = 700; // Maximum bet the bot will do (in bits).
var nextMulti = 3;
var nextBetMulti = 1.45;
...
engine.on('game_starting', function(info) {
    ...
    if ( lastBet > 0 || (engine.lastGamePlay() == 'LOST' &&  !firstGame)) { // If last game loss:
		...
		curBet = getMulti(curBet, nextBetMulti); 
