...
var streakSecurity = 7; // Number of loss-streak you wanna be safe for. Increasing this massively reduces the variableBase calculated. (1-loss = 20%, 2-loss = 5%, 3-loss = 1.25% of your maximum balance). Recommended: 2+
...
engine.on('game_starting', function(info) {
    ...
    if (engine.lastGamePlay() == 'LOST' && !firstGame) { // If last game loss:
        ...
        curBet *= 4; // Then multiply base bet by 4!
        currentMultiplier = 1 + (totalLosses / curBet);
